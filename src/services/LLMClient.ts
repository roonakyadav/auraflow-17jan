  ...
  async generate(prompt: string): Promise<string> {
    try {
      ...
      if (this.networkLogger) {
        const requestInfo = await this.networkLogger.logHttpRequest(
          sessionId,
          'https://api.groq.com/openai/v1/chat/completions',
          'POST',
          'Groq-SDK',
          '127.0.0.1' // In a real scenario, this would be the actual IP
        );
        ...
        await this.networkLogger.logHttpResponse(
          requestInfo.requestId,
          sessionId,
          'https://api.groq.com/openai/v1/chat/completions',
          'POST',
          200, // Assuming successful response
          startTime,
          result.length,
          'Groq-SDK',
          '127.0.0.1'
      ...
      if (this.networkLogger) {
        ...
        await this.networkLogger.logHttpRequest(
          sessionId,
          'https://api.groq.com/openai/v1/chat/completions',
          'POST',
          'Groq-SDK',
