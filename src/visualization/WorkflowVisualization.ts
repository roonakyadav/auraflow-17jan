...
export class WorkflowVisualization {
   ...
   */
  private static renderSequentialWorkflow(workflow: Workflow): string {
   ...
   */
  private static renderParallelWorkflow(workflow: Workflow): string {
   ...
   */
  private static renderParallelThenWorkflow(workflow: Workflow): string {
   ...
   */
  private static renderConditionalWorkflow(workflow: Workflow): string {
